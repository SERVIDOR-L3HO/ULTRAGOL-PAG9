...
async function loadTransmisiones() {
    try {
        ...
        const [data1, data2, data3, data4, data5, data6, data7, data8] = await Promise.all([
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 1 (rereyano):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones3', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 2 (e1link):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones2', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 3 (voodc):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones4', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 4 (transmisiones4):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones5', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 5 (donromans):', err.message);
                    return { matches: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones6', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 6 (external):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones7', 8000)
                .then(res => res.json())
                .catch(err => {
                    _log('⚠️ Error cargando API 7 (transmisiones7):', err.message);
                    return { transmisiones: [] };
                }),
            fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/transmisiones8', 8000)
                .then(res => res.json())
                .catch(err => {
...
async function fetchRealMatchStats(eventId) {
    ...
    try {
        const response = await fetch(`https://ultragol-api-3--olivia32809.replit.app/estadisticas/partido/${eventId}`, { signal: controller.signal });
        clearTimeout(timeoutId);
...
async function loadReplays() {
    ...
    try {
        const response = await fetch('https://ultragol-api-3--olivia32809.replit.app/videos');
        const data = await response.json();
...
async function loadStandings() {
    ...
    try {
        ...
        const response = await fetchWithTimeout(`https://ultragol-api-3--olivia32809.replit.app${endpoint}`, 8000);
        const data = await response.json();
...
async function loadLineups() {
    try {
        ...
        const response = await fetch(`https://ultragol-api-3--olivia32809.replit.app${endpoint}`);
        const data = await response.json();
        lineupsData = data;
