...
class NotificationManager {
    ...
    async getTeams() {
        ...
        try {
            ...
            try {
                const response = await fetchWithTimeout('https://ultragol-api-3--olivia32809.replit.app/Equipos', 5000);
                if (response.ok) {
    ...
    async startNotificationPolling() {
        ...
        console.log('📡 Polling API: https://ultragol-api-3--olivia32809.replit.app/notificaciones/ligamx');
    ...
    async checkForNotifications() {
        try {
            ...
            const apiUrl = 'https://ultragol-api-3--olivia32809.replit.app/notificaciones/ligamx';
            ...
            if (!response.ok) {
                ...
                const fallbackResponse = await fetch('https://ultragol-api-3--olivia32809.replit.app/notificaciones');
