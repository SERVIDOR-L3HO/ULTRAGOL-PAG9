...
// ==================== FUNCIONES MÉXICO VS PORTUGAL (TEMPORAL) ====================

// Función para abrir el modal de selección
function openMexPortugalModal() {
    const modal = document.getElementById('mexPortugalModal');
    modal.classList.add('active');
    console.log('✅ Modal México vs Portugal abierto');
}

// Función para cerrar el modal de selección
function closeMexPortugalModal() {
    const modal = document.getElementById('mexPortugalModal');
    modal.classList.remove('active');
    console.log('❌ Modal México vs Portugal cerrado');
}

// Función para reproducir el stream seleccionado
function playMexPortugal(url) {
    const iframe = document.getElementById('mexPortugalIframe');
    const playerModal = document.getElementById('mexPortugalPlayerModal');
    const selectionModal = document.getElementById('mexPortugalModal');
    
    // Cargar el stream
    iframe.src = url;
    
    // Cerrar el modal de selección y abrir el reproductor
    selectionModal.classList.remove('active');
    playerModal.classList.add('active');
    
    console.log('🎬 Reproduciendo México vs Portugal:', url);
    showToast('Cargando transmisión en vivo...');
}

// Función para cerrar el reproductor
function closeMexPortugalPlayer() {
    const iframe = document.getElementById('mexPortugalIframe');
    const playerModal = document.getElementById('mexPortugalPlayerModal');
    ...
    console.log('❌ Reproductor México vs Portugal cerrado');
